...
This repository contains the Payments service for the GPT-Line system.
...
This repository is responsible only for the Payments service and should not redefine cross-service contracts on its own.